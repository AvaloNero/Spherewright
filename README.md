...
The project is experimental and under active development. The original **M0 — First Red Matrix** milestone is complete; the current development save has also validated automatic power-engine, plastic, titanium-ingot, and diamond production plus same-star interplanetary flight. Work is now advancing through motors, water, and organic/titanium crystals toward the yellow-matrix production chain.
...
- automatic power engine, plastic, titanium ingot, and diamond: complete;
