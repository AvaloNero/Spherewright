...
- 日期/状态：2026-09-11，`validated`限本机原生现场语义与离线指南回归；新指南尚未冷部署。
...
- 限制/复验触发：不提供一般自动合网、路径或耗料保证；新增/拆除电力设施、供电或需求变化、更新reader/DSP、冷部署及独立产量窗口时复验。安装仍cd83b28，持续副产物去路IFX-104未关闭；关联IFX-105/EXP-188/297，最近复验同日。
