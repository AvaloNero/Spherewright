...
同日root供电重设计（`observed`，尚未施工）：4a056f2已推送后，只读raw-f7a12268明确选择现成倒数第二带3428→3404；原生native_single_belt_segment给inputOffset4/destination slot11，真实取料点距3080为10.0191312m，在10.5m内。这复用已有单带微调能力，不是扩大工具/白名单或更改覆盖门；旧19带与尾3427保留，没有新增电塔。后续仅fresh相同计划的1过滤分拣器、完整双端/供电读回和一次save，actual input与持续燃料另验。关联EXP-188/208/298，最近复验同日。
