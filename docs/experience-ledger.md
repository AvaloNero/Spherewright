...
- 状态：`observed`
- 日期：2026-09-07
- 适用范围：owned-world-001当前767安装态的普通分拣器建造、共享带供水与有界布局规划。
...
- 直接证据：本窗10个accepted均有独立terminal。#4拆旧空载sorter765后#5原生建storage复用765，#6另建2268；765至24326571仍空且无边。#8建2280终态24306579，24307575仓2268已含水13/塑料8/油4，sorter无过滤并持塑料1。#9至24313451才设置水过滤；随后24317088→24317765的677tick窗仓内水19/塑料106/油13/氢34均不变。现请求DTO与MCP签名没有初始过滤字段；这不是过滤配置操作注入了物品。
...
- 最近复验：2026-09-07（主会话复核十个terminal、24326004–24326571审计和24399620明确prebuild空页；旧767已安装，初始过滤修复尚在开发，不宣称live通过）。
