...
- 首见/状态：2026-09-11，`fixed_offline_live_pending`仅指产品指南补齐；原建造成功且现场误判已核销，不代表新指南已冷部署。
...
- 测试/边界：新增公开工具描述及嵌入资源回归，115项MCP测试通过；无新工具/DTO/动作域、无hash或执行语义变化。安装仍是cd83b28同批Plugin/MCP，新指南需随下一同批冷部署复验。IFX-104实际持续供给修复仍待独立观察/恢复，不因指南完成关闭。关联EXP-298/297。
