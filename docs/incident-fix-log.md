...
- 状态：`fixed_offline_live_pending`，这里的live待验专指实际回收/守恒/幸存对象核验。3074未拆、primary41312641/J78/accepted10；恢复后的非Agent位移待确认，未完成十写位置核销，不把预检正例标成实际回收。后续fresh单仓回收/重新放置各需独立证据。关联EXP-292。
