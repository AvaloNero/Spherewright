...
- 首见：2026-09-09，科研需求恢复后的石墨三窗36/42/36仍为unstable；原判据严格执行且原失败保留，不能认定现场所有波动仅来自计数量化。状态`fixed_offline_live_pending`。
...
- 验证：57项新回归、1662项总回归、完整Release零警告错误、真实MCP64/1/58878字符指南通过。新适配尚未部署/live，真实稳定基线和两倍持续十分钟仍待，不能用合成反例为旧实机失败改判。关联EXP-283及日记001。
