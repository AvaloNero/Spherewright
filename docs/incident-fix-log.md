...
- 状态：`fixed_offline_live_pending`，这里的live待验专指实际回收/守恒/幸存对象核验。3074未拆、primary41312641/J78；IFX-102已将恢复首读与后续位移分开完成十写核销，不把预检正例标成实际回收。后续fresh单仓回收/重新放置各需独立证据。关联EXP-292。
