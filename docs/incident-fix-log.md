...
- 验证与边界：详见[当档源码/测试记录](./gameplay-timeline.md#2026-09-18--显式单跨度高架带源码闭环实机待验)与[API研究](./research/game-api-foundry.md#implemented-single-span-proof-2026-09-18-offline-only)。2649aad已冷部署、同档恢复并严格核十写，两条固定坡道的完整native预检亦通过；尚未实机施工，不核销高架整桥、处理器供料、产量或高架保存恢复；未知读回仍隔离且不得重放。
